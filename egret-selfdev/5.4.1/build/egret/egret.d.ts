...
declare namespace egret {
    ...
    class EventDispatcher extends HashObject implements IEventDispatcher {
        ...
        clearListenerByType(type: string): void;
        /**
         * @inheritDoc
         * @version Egret 2.4
         * @platform Web,Native
        ...
        * 判断函数是否已注册事件监听
        */
        hasEventListenerEx(type: string, listener: Function, thisObject: any, useCapture?: boolean): boolean;
        /**
         * @inheritDoc
         * @version Egret 2.4
         * @platform Web,Native
...
declare namespace egret {
    ...
    type FullScreenModeName = "" | "normal" | "partialFull" | "fullScreen" | "partialFull_up" | "fullScreen_up" | "partialFull_down" | "fullScreen_down" | "partialFull_all" | "fullScreen_all";
    /**
    ...
    class DisplayObject extends EventDispatcher {
        private m_bRenderLogicHierarchyEnable;
        /**该容器是否启用渲染逻辑分层 */
        get bRenderLogicHierarchyEnable(): boolean;
        set bRenderLogicHierarchyEnable(value: boolean);
        private m_nRenderLogicHierarchy;
        /**该对象属于当前逻辑分层容器的第几个渲染逻辑层 */
        get nRenderLogicHierarchy(): number;
        set nRenderLogicHierarchy(value: number);
        private m_bRenderLogicLastRenderEnable;
        /**该容器是否启用渲染逻辑后处理*/
        get bRenderLogicLastRenderEnable(): boolean;
        set bRenderLogicLastRenderEnable(value: boolean);
        private m_bRenderLogicLastRender;
        /**该对象是否逻辑后渲染 (Tips:不是容器开关)*/
        get bRenderLogicLastRender(): boolean;
        set bRenderLogicLastRender(value: boolean);
        /**是否只作为像素检测，不进行渲染 */
        private m_bOnlyPixelHitTest;
        get bOnlyPixelHitTest(): boolean;
        set bOnlyPixelHitTest(value: boolean);
        private m_bOptimizeScrollRectEnable;
        /**该容器是否启用视口优化*/
        get bOptimizeScrollRectEnable(): boolean;
        set bOptimizeScrollRectEnable(value: boolean);
        /**TODO: 上层可以自定义采集函数*/
        private m_objOptimizeScrollRectFun;
        get objOptimizeScrollRectFun(): Function;
        set objOptimizeScrollRectFun(value: Function);
        /**由于引擎默认的scrollRect会导致滚动，避免造成意义耦合 */
        private m_objOptimizeScrollRect;
        get objOptimizeScrollRect(): Rectangle;
        set objOptimizeScrollRect(value: Rectangle);
        private $blendRecursionOpt;
        get bBlendRecursionOpt(): boolean;
        set bBlendRecursionOpt(value: boolean);
        /**
         ...
         */
        protected _$children: DisplayObject[];
        get $children(): any;
        set $children(value: any);
        getElementNodeNum(): any;
        private $name;
        /**
        ...
        private $concatenatedMatrixVer;
        /**
         * @private
         * 获得这个显示对象以及它所有父级对象的连接矩阵。
         */
        $getConcatenatedMatrix(ignoreAnchorOffset?: boolean): Matrix;
        ...
        $percentAnchorOffsetX: number;
        get percentAnchorOffsetX(): number;
        set percentAnchorOffsetX(value: number);
        $percentAnchorOffsetY: number;
        get percentAnchorOffsetY(): number;
        set percentAnchorOffsetY(value: number);
        $editorTempVisible: boolean;
        get editorTempVisible(): boolean;
        set editorTempVisible(value: boolean);
        /**
         * @private
         */
        ...
        protected m_bRenderVisible: boolean;
         ...
         * 考虑全屏界面剔除的isVisible
         */
        get isVisibleOC(): boolean;
        private $modal;
        get modal(): boolean;
        set modal(value: boolean);
        /** 优先模态检测的默认值 */
        static defaultModalPriority: boolean;
        /** 是否优先检测模态 */
        private $isModalPriority;
        get isModalPriority(): boolean;
        set isModalPriority(value: boolean);
        /**
         * @private
         */
        $skipTouch: boolean;
        /**
         * 显示对象是否忽略点击。忽略点击的显示对象将被在点击碰撞检测过默认为未命中。
         * @default false
         * @author limingqing
         */
        get skipTouch(): boolean;
        set skipTouch(value: boolean);
        /**
         * @private
        ...
        $cacheDirty: boolean;
        $cacheDirtyUp(): void;
        markDirtyUp(dirtyRender?: boolean): void;
        /**
         * @private
         */
        $alpha: number;
         ...
         */
        $maskRect: Rectangle;
        $maskRectangle: DisplayObject;
        $maskOpt: boolean;
        $supportStencilMask: boolean;
        $scissorMask: boolean;
        /**
         * @private
         * 作为深度使用的对象
         */
        $depthMaskObjs: DisplayObject[];
        $depthMaskInfoCache: any[];
        /**
         * @private
         * 被深度遮罩的对象数量（管理数量就行了，管理具体对象列表太麻烦了）
         */
        $depthMaskedCount: number;
        /**
        ...
        get maskOpt(): boolean;
        set maskOpt(value: boolean);
        get scissorMask(): boolean;
        set scissorMask(value: boolean);
        private onMaskRectChanged;
        protected refreshMaskRectangle(): void;
        private $setMaskRect;
        setDepthObjects(values: DisplayObject[]): boolean;
        removeDepthObjects(): void;
         ...
         * @language zh_CN
         */
        getTransformedBounds(targetCoordinateSpace: DisplayObject, resultRect?: Rectangle, ignoreMovieClip?: boolean): Rectangle;
        /**
         ...
         * @language zh_CN
         */
        getBounds(resultRect?: Rectangle, calculateAnchor?: boolean, ignoreMovieClip?: boolean): egret.Rectangle;
        /**
         * @private
         */
        $getTransformedBounds(targetCoordinateSpace: DisplayObject, resultRect?: Rectangle, ignoreMovieClip?: boolean): Rectangle;
        transformBounds(targetCoordinateSpace: DisplayObject, rectangle: Rectangle): Rectangle;
        /**
         ...
         * @language zh_CN
         */
        localToGlobal(localX?: number, localY?: number, resultPoint?: Point, ignoreAnchorOffset?: boolean): Point;
        /**
         * @private
         */
        $cacheOriBounds: {
         ...
         * @private
         */
        $enableCacheOriBounds: boolean;
        /**
         * @private
         * 获取显示对象占用的矩形区域集合，通常包括自身绘制的测量区域，如果是容器，还包括所有子项占据的区域。
         */
        $getOriginalBounds(ignoreMovieClip?: boolean): Rectangle;
        /**
         * @public
         */
        enableOriginalBoundsCache(enableCache?: boolean): void;
        /**
         * @private
         * 测量子项占用的矩形区域
         * @param bounds 测量结果存储在这个矩形对象内
         */
        $measureChildBounds(bounds: Rectangle, ignoreMovieClip?: boolean): void;
        /**
         * @private
         */
        $getContentBounds(ignoreMovieClip?: boolean, boundsOut?: egret.Rectangle): Rectangle;
        /**
         * @private
        ...
        get isFull(): boolean;
        get isPartialFull(): boolean;
        get isFullScreen(): boolean;
        get isPartialFullScreen(): boolean;
        get isFullScreenUp(): boolean;
        get isPartialFullScreenUp(): boolean;
        get isFullScreenDown(): boolean;
        get isPartialFullScreenDown(): boolean;
        get isFullScreenAll(): boolean;
        get isPartialFullScreenAll(): boolean;
        private $fullScreenNodeCount;
        get fullScreenNodeCount(): number;
        protected $addFullScreenNodeCount(value: number): void;
        setFullScreenMode(value: FullScreenModeName): void;
        private $hiddenFrameId;
        hiddenInThisFrame(): void;
        visibleInThisFrame(clear?: boolean): boolean;
        private $hiddenLastFrameId;
        /**
         * 判断上一帧是否渲染可见，只用于tick logic中判断，用于tick render可能会有错
         * @returns
         */
        visibleLastFrame(): boolean;
        /**是否跳过hitTest */
        get isSkipHitTest(): boolean;
        get isVisual(): boolean;
        isOccludee(): boolean;
        getOccluderRect(): Rectangle | null;
        getOccludeeRect(resultRect?: Rectangle): Rectangle;
        /**模板类名或者路径 */
        private $tweenSkin;
        set tweenSkin(value: string);
        get tweenSkin(): string;
        /**模板使用的动画组合名 */
        private $tweenName;
        set tweenName(value: string);
        get tweenName(): string;
        /**通过模板生成的动画组 */
        private $tweenGroup;
        set tweenGroup(value: any);
        get tweenGroup(): any;
        /**当模板没有加载完成时，用来记录播放标记，加载完成后控制是否播放。没有采用播放函数，因为在这个文件内tween动画无法引用 */
        private $isPlayingTween;
        set isPlayingTween(value: boolean);
        get isPlayingTween(): boolean;
        createTweenGroup(callback: Function): void;
        playTweenGroup(): void;
        stopTween(): void;
        destoryTween(): void;
        private $hasErrorInfo?;
        clearErrorInfo(): void;
        markHasErrorInfo(): void;
        get hasErrorInfo(): boolean;
        matLocalToUV?: Matrix;
        uv2Clamp?: number[];
        allowUV2Clamp: boolean;
        /**是否即时运用(默认为true) */
        private $isInstantApplyColTune;
        get isInstantApplyColTune(): boolean;
        set isInstantApplyColTune(value: boolean);
        private $colDirty;
        private colDirty;
        private validateColTune;
        private $colBlackAndWhite;
        get colBlackAndWhite(): boolean;
        set colBlackAndWhite(value: boolean);
        private $colUseColor;
        get colUseColor(): boolean;
        set colUseColor(value: boolean);
        private $colR;
        get colR(): number;
        set colR(value: number);
        private $colG;
        get colG(): number;
        set colG(value: number);
        private $colB;
        get colB(): number;
        set colB(value: number);
        private $colHue;
        get colHue(): number;
        set colHue(value: number);
        private $colSaturate;
        get colSaturate(): number;
        set colSaturate(value: number);
        private $colBrightness;
        get colBrightness(): number;
        set colBrightness(value: number);
        private $colContrast;
        get colContrast(): number;
        set colContrast(value: number);
        get colTuneOptions(): ColTuneMatrixOptions;
        private getColTuneMatrix;
    }
    interface ColTuneMatrixOptions {
    ...
    let $GlobalFrameID: number;
    function UpdateGlobalFrameID(): void;
    function SetGlobalConcatenatedMatrixCache(val: boolean): void;
    function getDisplayObjectGAlpha(displayObject: egret.DisplayObject): number;
}
declare namespace egret {
    /**
     * @private
...
declare namespace egret {
    ...
    class Bitmap extends DisplayObject {
        ...
        protected $textureWidthOriginEx: number;
        protected $textureHeightOriginEx: number;
        protected $textureWidthOrigin: number;
        protected $textureHeightOrigin: number;
        protected createNativeDisplayObject(): void;
        /**
         * @private
         * 显示对象添加到舞台
         ...
         * @private
         */
        protected setImageSizeEx(textureWidth: number, textureHeight: number): void;
        /**
         * @private
         */
        protected setImageOriginSize(originWidth: number, originHeight: number): void;
        /**
         * @private
         */
...
declare namespace egret {
    ...
    class DisplayObjectContainer extends DisplayObject {
        ...
        /**是否禁用碰撞检测 */
        static $DISABLE_HIT_TEST: boolean;
        /**
         ...
         * @returns
         */
        getAllChildCount(onlyVisible?: boolean): number;
        /**
         * 获取所有可见且alpha=0的节点数量
         * @returns
         */
        getAllVisibleAlphaZeroChildCount(): number;
        /**
         ...
         * @private
         */
        $setChildNoFoud(value: boolean): boolean;
        $getChildNoFoud(): boolean;
        get childNoFoud(): boolean;
        set childNoFoud(value: boolean);
        /**忽略测量子项 */
        $ignoreChildMeasure: boolean;
        /**
         * @private
         */
        $setIgnoreChildMeasure(value: boolean): boolean;
        $getIgnoreChildMeasure(): boolean;
        get ignoreChildMeasure(): boolean;
        set ignoreChildMeasure(value: boolean);
        /**
         * @private
         */
        $hitTest(stageX: number, stageY: number): DisplayObject;
...
declare namespace egret {
    ...
    class Texture extends HashObject {
         ...
         */
        $offsetY: number;
        $compressAutoScaleFactor: number;
        /**
         * @private
         * 纹理宽度
         */
         ...
         * @private 纹理原始宽度
         */
        $textureOriginWidth: number;
        /**
         * @private 纹理原始高度
         */
        $textureOriginHeight: number;
        /**
         * @private
         * 表示bitmapData.width
         */
        ...
        */
         ...
         * @param sourceHeight
         */
        $initData(bitmapX: number, bitmapY: number, bitmapWidth: number, bitmapHeight: number, offsetX: number, offsetY: number, textureWidth: number, textureHeight: number, sourceWidth: number, sourceHeight: number, rotated?: boolean, textureOriginWidth?: number, textureOriginHeight?: number): void;
        /**
         * @deprecated
         */
...
declare namespace egret {
    ...
    class Event extends HashObject {
        ...
        static ERROR: string;
        static SCROLLRECT_CHANGE: string;
        /**
...
declare namespace egret.sys {
    ...
    class RenderNode {
        ...
        glFormat: string;
        /**
         * gl pixel texel format
         */
        glType: string;
        /**节点渲染分层所属层级 */
        nRenderLogicHierarchy: number;
        /**节点是否被后渲染 */
        bRenderLogicLastRender: boolean;
    }
}
declare namespace egret.sys {
    /**
...
declare namespace egret_native {
    ...
    class NativeDisplayObject {
        ...
        addCallBack(type: string, listener: Function, thisobj: any): any;
...
declare namespace egret {
    function reloadBitmapData(bitmapData: BitmapData, bitmap: any, callback?: Function, thisObj?: any): void;
    ...
    const vertical_alpha_mask = "vertical_alpha_mask";
    const horizontal_alpha_mask = "horizontal_alpha_mask";
    ...
    const PROFILE_WEBGLTEXTURE_USER_DATA = "userdata";
    const GL_FORMAT_RGBA = "RGBA";
    const GL_FORMAT_RGB = "RGB";
    const GL_FORMAT_LUMINANCE_ALPHA = "LUMINANCE_ALPHA";
    const GL_FORMAT_LUMINANCE = "LUMINANCE";
    const GL_FORMAT_ALPHA = "ALPHA";
    const GL_TYPE_UNSIGNED_BYTE = "UNSIGNED_BYTE";
    const GL_TYPE_UNSIGNED_SHORT_4_4_4_4 = "UNSIGNED_SHORT_4_4_4_4";
    const GL_TYPE_UNSIGNED_SHORT_5_5_5_1 = "UNSIGNED_SHORT_5_5_5_1";
    const GL_TYPE_UNSIGNED_SHORT_5_6_5 = "UNSIGNED_SHORT_5_6_5";
    enum BatchType {
        Batch = 0,
        Disable = 1,
        Ignore = 2,
    ...
    class BitmapData extends HashObject {
         ...
         */
        $source: any;
        private $noBlankWidth;
        private $noBlankHeight;
        private $originWidth;
        private $originHeight;
        private $scaleOriginWidth;
        private $scaleOriginHeight;
        /**
         * WebGL texture.
         * @version Egret 2.4
         * @platform Web,Native
         ...
         *
         */
        compressedTextureData: Array<Array<CompressedTextureData>>;
        debugCompressedTextureURL: string;
        $etcAlphaMask: Nullable<BitmapData>;
        verticalAlphaMask: boolean;
        horizontalAlphaMask: boolean;
        private $uriValue;
        private $url;
        get url(): string;
        batchType: BatchType;
        ...
        get noBlankWidth(): number;
        get noBlankHeight(): number;
        get width(): number;
        set width(value: number);
        get height(): number;
        set height(value: number);
        get originWidth(): number;
        set originWidth(value: number);
        get originHeight(): number;
        set originHeight(value: number);
        get scaleOriginWidth(): number;
        set scaleOriginWidth(value: number);
        get scaleOriginHeight(): number;
        set scaleOriginHeight(value: number);
        /**
        ...
        static create(type: "arraybuffer" | "base64", data: ArrayBuffer | string, callback?: (bitmapData: BitmapData) => void, byteOffset?: number, byteLength?: number): BitmapData;
        static createFromImageData(data: ImageData): BitmapData;
        static createFromArrayBuffer(data: ArrayBuffer, width: number, height: number): BitmapData;
        static createFromCompressedTexture2D(data: Uint8Array, width: number, height: number, noBlankWidth: number, noBlankHeight: number, format: number): BitmapData;
        static createFromCompressedTexture2D(data: Uint8Array, width: number, height: number, noBlankWidth: number, noBlankHeight: number, format: number, originWidth: number, originHeight: number): BitmapData;
        static createFromCompressedTexture2D(data: Uint8Array, width: number, height: number, noBlankWidth: number, noBlankHeight: number, format: number, originWidth: number, originHeight: number, scaleWidth: number, scaleHeight: number): BitmapData;
        $dispose(): void;
        ...
        validWithBitmapData(other: BitmapData, bitmap: any): void;
    }
}
declare namespace egret {
    /**
...
declare namespace egret {
    /**
     * A class that provides constant values for visual blend mode effects. These constants are used in the FeatureLevel
     * property of the DisplayObject class.
     * @see egret.DisplayObject#FeatureLevel
     * @version Egret 2.4
     * @platform Web,Native
     * @includeExample egret/display/FeatureLevel.ts
     * @see http://edn.egret.com/cn/docs/page/108 显示容器的概念与实现
     * @language en_US
     */
    /**
     * 提供混合模式可视效果的常量值的类,通常用于 DisplayObject 的 FeatureLevel 属性上。
     * @see egret.DisplayObject#FeatureLevel
     * @version Egret 2.4
     * @platform Web,Native
     * @includeExample egret/display/FeatureLevel.ts
...
declare namespace egret.sys {
    /**
     * @private
     * 转换 FeatureLevel 字符串为数字。
     */
    function featureLevelToNumber(FeatureLevel: string): number;
    /**
     * @private
     * 转换数字为 FeatureLevel 字符串。
     */
    function numberToFeatureLevel(FeatureLevel: number): string;
}
declare namespace egret {
    /**
...
declare namespace egret {
     ...
     * A class that provides constant values for visual blend mode effects. These constants are used in the blendMode
     * property of the DisplayObject class.
     * @see egret.DisplayObject#maskOpt
     * @version Egret 2.4
     * @platform Web,Native
     * @includeExample egret/display/BlendMode.ts
     * @see http://edn.egret.com/cn/docs/page/108 显示容器的概念与实现
...
declare namespace egret.sys {
     ...
     * 转换 maskOpt 字符串为数字。
     */
    function maskOptToNumber(maskOpt: string): number;
    /**
     * @private
     * 转换数字为 maskOpt 字符串。
     */
    function numberToMaskOpt(maskOpt: number): string;
}
declare namespace egret {
    /**
     * @private
...
declare namespace egret {
    ...
    class RenderTexture extends egret.Texture {
         ...
         * @inheritDoc
         */
        dispose(del?: boolean): void;
    }
}
declare namespace egret {
    class SdfGraphics extends HashObject {
        private x;
        private y;
        private width;
        private height;
...
declare namespace egret {
    /**新增一个SdfShape。用于在代码中快捷使用 */
    class SdfShape extends DisplayObjectContainer {
        constructor();
...
declare namespace egret {
    ...
    class Stage extends DisplayObjectContainer {
        ...
        private $modalDisplayObject;
        private $modalStackObjs;
        private removeObjFromStack;
        set modalObj(obj: DisplayObject);
        get modalObj(): DisplayObject;
        $hitTestWithModal(stageX: number, stageY: number): DisplayObject;
        /**
         * @private
         */
        ...
        private $enableOC;
        set enableOC(val: boolean);
        get enableOC(): boolean;
        private $enableOCDebugDraw;
        set enableOCDebugDraw(val: boolean);
        get enableOCDebugDraw(): boolean;
    }
}
declare namespace egret {
    /**
...
declare namespace egret {
    function deliverEvent(evt: egret.Event, instance: any, data?: any): void;
    function deliverTouchEvent(type: string, instance: any, data?: any): void;
    interface IEventAdapter {
        deliverEvent(evt: egret.Event, instance: any, data?: any): void;
        deliverTouchEvent(type: string, instance: any, data?: any): void;
    }
}
declare namespace egret {
    /**
...
declare namespace egret {
    ...
    class TextEvent extends Event {
        ...
        /**
         * 在绘制调用 drawText 的时候的回调，这个时候的数据是最新的。
         * @version Egret 2.4
         * @platform Web,Native
         * @language zh_CN
         */
         ...
         * @language zh_CN
         */
        static dispatchTextEvent(target: IEventDispatcher, type: string, touchSendData?: TextTouchData): boolean;
    }
}
declare namespace egret {
    interface Timer {
...
declare namespace egret {
    ...
    class TouchEvent extends Event {
        ...
        /**
         * 当用户鼠标移入游戏时的调度（仅在网页端生效）
         */
        static MOUSE_ENTER: "mouseEnter";
        /**
         * 当用户鼠标移出游戏时的调度（仅在网页端生效）
         */
        static MOUSE_LEAVE: "mouseLeave";
        static TOUCH_CANVAS: "touchCanvas";
        /**
        ...
        static TOUCH_TAP_OUTSIDE: "touchTapOutside";
        /**
...
declare namespace egret {
    ...
    let ExternalInterface: {
         ...
         * @language zh_CN
         */
        callbackString(functionName: string, value: string): string;
        /**
...
declare namespace egret {
    /** 纯灰色 */
    const colorGrey: number[];
    /** 亮灰色 */
    const colorGreyLight: number[];
    /** 暗灰色 */
    const colorGreyDark: number[];
    ...
    class ColorMatrixFilter extends Filter {
        ...
        get color4x5Prefabs(): number[][];
        set color4x5Prefabs(values: number[][]);
        /**
         * matrix的复制版，主要用于编辑器中的shader属性设置
         * 构成应用于所呈示的元素的一个 4x5 矩阵的、以逗号分隔的 20 个双精度数的列表。
         * 矩阵以行作为主要顺序，即用第一行五个元素乘以矢量 [srcR,srcG,srcB,srcA,1] 以确定输出的红色值，用第二行的五个元素确定输出的绿色值，等等。
         * 该值必须为 20 个数字组成的数组或以逗号分隔的字符串。
         * @version Egret 3.1.0
        ...
        private _multiply2;
        private _loadMatrix;
        _loadMatrix2(matrix: number[], multiply?: boolean): void;
        private limitValue;
        /**
         * Adjusts brightness
         *
         ...
         * -255 to 255
         */
        brightness2(value: number, multiply: boolean): void;
        /**
        * RGB
        * 0 to 255
        */
        colorRGB(colorR: number, colorG: number, colorB: number, multiply: boolean): void;
        /**
         ...
         * 黑白
         */
        blackAndWhite2(multiply: boolean): void;
        /**
         ...
         * -180 to 180
         */
        hue2(value: number, multiply: boolean): void;
        /**
         ...
         * -100 to 100
         */
        contrast2(value: number, multiply: boolean): void;
        /**
         ...
         * -100 to 100
         */
        saturate2(value: number, multiply: boolean): void;
        /**
...
declare namespace egret {
    ...
    class CustomFilter extends Filter {
         ...
         */
        $vertexSrc: string;
        $vertexSrcBase: string;
        /**
         * @private
         */
        $fragmentSrc: string;
        $fragmentSrcBase: string;
        /**
         * @private
         */
        $shaderKey: string;
        private $shaderKeyBase;
        /**
         * @private
         */
        type: string;
         ...
         */
        $textures: {
            [key: string]: Texture | Array<Texture>;
        };
        get textures(): {
            [key: string]: Texture | Array<Texture>;
        };
         ...
         * @language zh_CN
         */
        constructor(vertexSrc: string, fragmentSrc: string, key: string, uniforms?: any);
        /**
         ...
         */
        onPropertyChange(): void;
        bindTexture(webglContext: egret.sys.RenderContext): void;
        disposeTexture(): void;
        private $_alphaMode;
        updateAlphaMacro(alphaMode: number): void;
        private $injectMacro;
    }
}
declare namespace egret {
...
declare namespace egret {
    ...
    class Rectangle extends HashObject {
        ...
        inflateRect(rect: Rectangle, dx: number, dy: number): void;
        /**
         * @private
         */
        ...
        unionOpt(toUnion: Rectangle, result: Rectangle): Rectangle;
        /**
         * @private
         */
    ...
    let $TempRectangle2: Rectangle;
    let $TempRectangle3: Rectangle;
}
declare namespace egret {
}
declare namespace egret {
...
declare namespace egret {
    ...
    interface Sound extends EventDispatcher {
         ...
         * @language zh_CN
         */
        load(url: string, useCache?: boolean): void;
        /**
         ...
         * @language zh_CN
         */
        play(startTime?: number, loops?: number, useStream?: boolean): SoundChannel;
        /**
...
interface CanvasDrawImage {
    ...
    drawImage(image: CanvasImageSource | OffscreenCanvas, sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number): void;
}
declare function createImageBitmap(image: ImageBitmapSource | OffscreenCanvas): Promise<ImageBitmap>;
declare function createImageBitmap(image: ImageBitmapSource | OffscreenCanvas, sx: number, sy: number, sw: number, sh: number): Promise<ImageBitmap>;
interface Worker {
...
declare namespace egret {
    type runEgretOptions = {
        ...
        showLog?: boolean;
        fpsStyles?: string;
        enableLimitScreenBufferSize?: boolean;
        limitScreenBufferSize?: number;
    };
    var runEgretOptionsIns: runEgretOptions;
    /**
...
declare namespace egret {
    ...
    interface FPSDisplay {
        ...
        updateSingle(key: string, showKey: string, value: any): void;
        /**
         * 插入一条log信息
         */
...
interface FPSData extends Object {
    ...
    ocComputed: number;
    ocCulled: number;
    curLoadingCnt?: number;
    curSkinConstructCnt?: number;
    jankCnt?: number;
    bigJankCnt?: number;
}
declare namespace egret.sys {
    ...
    class Player extends HashObject {
         ...
         * 实例化一个播放器对象。
         */
        constructor(buffer: RenderBuffer, stage: Stage, entryClassName: string, entryClass?: any);
        /**
         * @private
         */
         ...
         */
        updateStageSize(stageWidth: number, stageHeight: number, displayW: number, diesplayH: number): void;
        /**
         * @private
         * 显示FPS。
         */
    ...
    type JankData = {
        /**
         * 某一帧耗时同时满足以下两个条件时，jank_counts+1
         *  1、耗时 大于 前三帧平均耗时2倍
         *  2、耗时 大于 两帧电影帧耗时（84ms）
         */
        jankCounts: number;
        /**
         * 某一帧耗时同时满足以下两个条件时，big_jank_counts+1
         *  1、耗时 大于 前三帧平均耗时2倍
         *  2、耗时 大于 三帧电影帧耗时（125ms）
         */
        bigJankCounts: number;
        /**
         * 当某一帧jank_counts+1时，jank_time += 此帧耗时
         */
        jankTime: number;
    };
    ...
    const FPS_LOW_30: number;
    const FPS_MIDDLE_30: number;
    const FPS_LOW_60: number;
    const FPS_MIDDLE_60: number;
    function getPerformace(): PerformanceInfo;
    function startGetPerformance(interval?: number): void;
    function stopGetPerformance(): void;
    function startIntervalCache(interval?: number): void;
    function enableOC(active: boolean): void;
    function enableOCDebugDraw(active: boolean): void;
    let disableRGBA4444: boolean;
    let enableAdRect: boolean;
    let enableAdRectAlpha: boolean;
    let enableLogicTickFull: boolean;
    let defaultLogicTickFullDiff: number;
    let enableNextFrameRender: boolean;
    let openReleaseTryCatch: boolean;
    let enableRenderText: boolean;
    let enableTextBold: boolean;
    let enableLimitOutputScreenSize: boolean;
    let limitOutputScreenSizeWidth: number;
    let enableMask: boolean;
    let enableCompressAutoScale: boolean;
    let enablePixelHitTest: boolean;
    let supportEUIComponentLateInit: boolean;
    /**
     * 是否允许Skin构造切片,将集中的构造切分到多帧完成，可以改善由于Skin构造导致线程阻塞情况;
     * 但是会导致构造时间变得更长
     */
    let allowSkinConstructSlice: boolean;
    let enableSkinConstructSliceDebug: boolean;
    let enableSkinTweenConstructSimple: boolean;
    let enableTweenItemPathStreaming: boolean;
    let enableFeatureLevel: boolean;
    let engineFeatureLevel: number;
    function setFeatureLevel(l: string): void;
    let enableRecursionFilter: boolean;
    let enableEffectFilters: boolean;
    let enableSharpenFilter: boolean;
    let isContextLost: boolean;
    let disableGLClear: boolean;
    let checkCompressTextureInternalFormat: boolean;
    let debugListGenDefaultData: boolean;
    let minigameRequestUseHighPerMode: boolean;
...
declare namespace egret {
    ...
    class StageScaleMode {
        ...
        static MINIGAME_HIGH_PERF_PLUS_SHOW_ALL: string;
        /**
...
declare namespace egret.sys {
    /** 是否开启自动合批 */
    let openAutoBatch: boolean;
    /** 自动合图管理 */
    let textureAtlasManager: any;
    /** 自动合批*/
    let openBatchTextureCmd: boolean;
    /** 程序字自身不用考虑合批逻辑 */
    let textBatchIgnoreSelf: boolean;
    /**引擎总开关: 是否开启渲染逻辑分层 */
    let openRenderLogicHierarchy: boolean;
    /**引擎总开关: 是否开启渲染后处理*/
    let openRenderLogicLastRender: boolean;
    /**引擎总开关: 是否开启渲染后处理文本 (前提条件为openRenderRenderLogicLastRender = true才生效) */
    let openRenderLogicLastRenderText: boolean;
    /**
     * @private
     */
     ...
     * 是否收集RT内存，用于profile
     */
    let profileWebGLTexture: boolean;
    ...
    interface SystemRenderer {
         ...
         */
        render(displayObject: DisplayObject, buffer: RenderBuffer, matrix: Matrix, forRenderTexture?: boolean): RenderOutput;
        /**
        ...
        renderClear(): any;
        addBuiltInShader(vertSource: string, fragSource: string, key: string): void;
    }
    /**
     *
     */
    ...
    * 仅通过bitmapData创建纹理
    */
    function createTexture(renderContext: RenderContext, bitmapData: BitmapData | HTMLCanvasElement, premultiplyAlpha?: boolean, glFormat?: string, type?: string): WebGLTexture;
    /**
    * 通过 width, height, data创建纹理
    */
    function _createTexture(renderContext: RenderContext, width: number, height: number, data: any, premultiplyAlpha?: boolean, glFormat?: string, type?: string): WebGLTexture;
    /**
     * 创建压缩纹理
     * @param renderContext
     * @param data
     ...
     * @returns
     */
    function createCompressedTexture(renderContext: RenderContext, data: Uint8Array, width: number, height: number, levels: number, internalFormat: number, premultiplyAlpha?: boolean): WebGLTexture;
    /**
     * 更新纹理
     * @param renderContext
     * @param texture
     ...
     * @param type
     */
    function updateTexture(renderContext: RenderContext, texture: WebGLTexture, bitmapData: BitmapData, premultiplyAlpha?: boolean, format?: string, type?: string): void;
    /**
     * 更新纹理
     * @param renderContext
     * @param texture
     ...
     * @param type
     */
    function _updateTexture(renderContext: RenderContext, texture: WebGLTexture, width: number, height: number, data: any, premultiplyAlpha?: boolean, format?: string, type?: string): void;
    /**
     * 删除纹理
     * @param webglTexture
     */
    function deleteTexture(webglTexture: WebGLTexture): void;
    function getWebGLTexture(webglContext: RenderContext, texture: Texture, premultiplyAlpha?: boolean, format?: string, type?: string): any;
    /**
     * 画texture
     **/
     ...
     * @param text
     */
    function measureTextWith(context: CanvasRenderingContext2D, text: string, cacheType?: string): number;
    /**
    ...
    let systemRenderer2: SystemRenderer;
    let customHitTestBuffer2: sys.RenderBuffer;
    function openMultipleRender(): void;
}
declare namespace egret.sys {
    /**
     * @private
    ...
    class SystemTicker extends EventDispatcher {
         ...
         */
        resume(): void;
        private lastLogicTimeStamp;
        private lastRenderTimeStamp;
        private lastLogicCost;
        private lastRequestRenderingFlag;
        get lastRenderCostTime(): number;
        private m_bFrameDebug;
        get bFrameDebug(): boolean;
        set bFrameDebug(value: boolean);
        gotoNextFrameDebug(passedTime?: number): void;
        /**
         * @private
         * 执行一次刷新
         */
...
declare namespace egret.sys {
    ...
    class TouchHandler extends HashObject {
         ...
         * @private
         */
        onMouseEnter(x: number, y: number, touchPointID: number): void;
        /**
         * @private
         */
        onMouseLeave(x: number, y: number, touchPointID: number): void;
        /**
         * @private
         */
        private lastTouchX;
         ...
         */
        private findTarget;
        onEventHook: Function;
        disableSysEvent: boolean;
        /**
         * @private
         * 设置同时触摸数量
         */
...
declare namespace egret.sys {
    ...
    class BitmapNode extends RenderNode {
         ...
         */
        cleanBeforeRender(): void;
        static $updateTextureData(node: sys.NormalBitmapNode, image: BitmapData, bitmapX: number, bitmapY: number, bitmapWidth: number, bitmapHeight: number, offsetX: number, offsetY: number, textureWidth: number, textureHeight: number, destW: number, destH: number, sourceWidth: number, sourceHeight: number, fillMode: string, smoothing: boolean, textureExplicitWitdth?: number, textureExplicitHeight?: number): void;
        /**
         * @private
         * 绘制九宫格位图
         */
        static $updateTextureDataWithScale9Grid(node: sys.BitmapNode, image: BitmapData, scale9Grid: egret.Rectangle, bitmapX: number, bitmapY: number, bitmapWidth: number, bitmapHeight: number, offsetX: number, offsetY: number, textureWidth: number, textureHeight: number, destW: number, destH: number, sourceWidth: number, sourceHeight: number, smoothing: boolean, textureExplicitWitdth?: number, textureExplicitHeight?: number): void;
        /**
         * @private
         */
 ...
 */
declare namespace egret.sys {
    class SdfGraphicsNode extends RenderNode {
        x: number;
        y: number;
        width: number;
        height: number;
...
declare namespace egret.sys {
    ...
    class TextNode extends RenderNode {
         ...
         */
        fontFamily: string;
        fontFamilyOffsetX: number;
        fontFamilyOffsetY: number;
        shadow: boolean;
        shadowColor: number;
        shadowOffsetX: number;
        shadowOffsetY: number;
        ...
        /**
         * 绘制一行数据
         * 如果需要两端对齐（属性对齐），则拆分一行数据，绘制 words.len 行，由于Y偏移一致，看起来还是一行数据
         * @param offsetColumnGapArr 单行字体偏移量，若数据长度为1，则表示单行数据的偏移，没有设置两端对齐
         * @param y 文本垂直偏移量
         * @param text 绘制文本
         * @param format 文本格式
         */
        drawText(offsetColumnGapArr: number[], y: number, text: string, format: TextFormat): void;
        /**
         * 绘制x偏移
         */
        x: number;
        ...
        $canvasScaleY: number;
        $atlasMainPage: any;
        dirtyTextValue: boolean;
        $dirtyTextValue: number[];
        private $textValue;
        get textValue(): number;
        set textValue(val: number);
        updateTextValue(): void;
        cleanDirtyTextValue(): void;
        cleanTextAtlas(): void;
        /**
         * 清除非绘制的缓存数据
         */
...
declare namespace egret {
    class CanvasRenderer {
        private nestLevel;
        render(displayObject: DisplayObject, buffer: sys.RenderBuffer, matrix: Matrix, forRenderTexture?: boolean): sys.RenderOutput;
        /**
         * @private
         * 绘制一个显示对象
         */
...
declare namespace egret {
    ...
    class Capabilities {
        ...
        static innerTest: boolean;
        static readonly supportAntialias: boolean;
        static readonly supportedDdxDdy: boolean;
    }
}
declare namespace egret {
    /**
...
declare namespace egret.sys {
    ...
    const enum TextKeys {
        ...
        shadow = 42,
        shadowColor = 43,
        shadowColorString = 44,
        shadowOffsetX = 45,
        shadowOffsetY = 46,
        shadowBlur = 47,
        linethrough = 48,
        autoAdjustFontSize = 49,
        isWarmStyle = 50,
        onDarkBg = 51,
        gradientType = 52,
        gradientColors = 53,
...
declare namespace egret {
    let textAtlasRenderEnable: boolean;
    let textAtlasRenderer: any;
    let textAtlasRendererOffsetY: number;
    let textAtlasMaxFontSize: number;
    let textAtlasMainPage: any;
    /**
    ...
    class TextField extends DisplayObject {
         ...
         * @language zh_CN
         */
        static $fontFamily_offset: {
            [key: string]: [number, number];
        };
        static get fontFamily_offset(): {};
        static set fontFamily_offset(value: {
            [key: string]: [number, number];
        });
        /**
         * 字体fontFamily映射，解决字体在不同系统下的差异问题
         */
        static $fontFamily_map: {
            [key: string]: string;
        };
        static get fontFamily_map(): {};
        static set fontFamily_map(value: {
            [key: string]: string;
        });
        /**
         * 获取文本使用的原始字体，例如 设置的是font_default ，实际需要为font_default_s2
         * @param fontFamily
         * @returns
         */
        static getOriginFontFamily(fontFamily: string): any;
        static $fontFamily_map_reverse: {
            [key: string]: string;
        };
        static get fontFamily_map_reverse(): {};
        static set fontFamily_map_reverse(value: {
            [key: string]: string;
        });
        static defaultFontOffset: [number, number];
        /**
         * @version Egret 2.4
         * @platform Web,Native
         */
        ...
        $setShadow(value: boolean): boolean;
        get shadowColor(): number;
        set shadowColor(value: number);
        $setShadowColor(value: number): boolean;
        get shadowOffsetX(): number;
        set shadowOffsetX(value: number);
        $setShadowOffsetX(value: number): boolean;
        get shadowOffsetY(): number;
        set shadowOffsetY(value: number);
        $setShadowOffsetY(value: number): boolean;
        get shadowBlur(): number;
        set shadowBlur(value: number);
        $setShadowBlur(value: number): boolean;
        get underline(): boolean;
        set underline(value: boolean);
        $setUnderline(value: boolean): boolean;
        get linethrough(): boolean;
        set linethrough(value: boolean);
        private $setLinethrough;
        get autoAdjustFontSize(): boolean;
        set autoAdjustFontSize(value: boolean);
        private $setAutoAdjustFontSize;
        get richmode(): boolean;
        set richmode(value: boolean);
        private $setRichmode;
        /**是否两端对齐 */
        get autoAdjustAlign(): boolean;
        set autoAdjustAlign(value: boolean);
        /**
         * @private
         *
         */
        ...
        set gradientType(value: string);
        private $setGradientType;
        private $arraysEquals;
        get gradientColors(): string[];
        set gradientColors(value: string[]);
        private $setGradientColors;
        get gradientAlphas(): number[];
        set gradientAlphas(value: number[]);
        private $setGradientAlphas;
        get gradientRatios(): number[];
        set gradientRatios(value: number[]);
        private $setGradientRatios;
        get gradientMatrix(): Matrix;
        set gradientMatrix(value: Matrix);
        private $setGradientMatrix;
        get gradientPoints(): number[];
        set gradientPoints(value: number[]);
        private $setGradientPoints;
        /**
         ...
         */
        set text(value: string);
        get isWarmStyle(): boolean;
        set isWarmStyle(bool: boolean);
        get onDarkBg(): boolean;
        set onDarkBg(bool: boolean);
        private $textArr;
        private $richColor;
        private $richSize;
        private $touchEvent;
        private $gradientData;
        private $textStyleStack;
        private $doSetRichText;
        private pushTextStyle;
        private popTextStyle;
        private $setRichText;
        private $parseSpecial;
        ...
        get bgColorType(): string;
        set bgColorType(value: string);
        static TextColorUtils: {
            isLowBgColor: (color: number) => boolean;
            isDeepBgColor: (color: number) => boolean;
            getReverseColorNum: (id: number) => number;
        };
        private $setbgColorType;
        /**
         * @private
         *
         */
        ...
        private drawText;
        /**单行两端对齐，每个字所需要的偏移量 */
        private getAlignOffsetArr;
        private addEvent;
        private removeEvent;
        private getIWTextPos;
...
declare namespace egret {
    ...
    class TextFieldUtils {
         ...
         * @private
         */
        static $getTextElement(textfield: egret.TextField, x: number, y: number): [IWTextElement, IHitTextElement];
        /**
         * 获取文本点击块
         * @param textfield 文本
         * @param x x坐标值
...
declare namespace egret.sys {
     ...
     * @param italic 是否斜体
     */
    let measureText: (text: string, fontFamily: string, fontSize: number, bold: boolean, italic: boolean, cacheType?: string) => number;
    let measureAtlasText: (text: string, fontFamily: string, fontSize: number, bold: boolean, italic: boolean) => TextMetrics;
}
declare namespace egret {
    /**
...
declare namespace egret {
    ...
    */
    ...
    class Base64Util {
         ...
         * @platform Web,Native
         */
        static encode(data: ArrayBuffer | Uint8Array): string;
        static encode_utf8(str: string): string;
        /**
         * @language en_US
         * decode base64.
         * @version Egret 2.4
        ...
        static decode_utf8(base64: string): string;
    }
}
/**
 * @private
...
declare namespace egret {
    ...
    function id2Text(textid: string): string;
}
declare namespace egret {
    /**
...
declare namespace egret {
    ...
    let $callAsyncFunctionMap: {
        [key: string]: any;
    };
    let $callAsyncThisMap: {
        [key: string]: any;
    };
    let $callAsyncArgsMap: {
        [key: string]: any;
    };
    function $callAsyncByType(type: string, method: Function, thisObject: any, ...args: any[]): void;
}
declare namespace egret {
    /**
...
declare namespace egret {
    ...
    class WebGLUtils {
        ...
        /**
         * @param colors rgba(1,1,1,1)
         */
        static formatMeshColors(colors: number[]): number;
    }
}
